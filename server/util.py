...
def get_cropped_image_if_2_eyes(image_path, image_base64_data):
    face_cascade = cv2.CascadeClassifier('D:/Naval Projects/Spotrs_Person_Classifier/server/haarcascades/haarcascade_frontalface_default.xml')
    eye_cascade = cv2.CascadeClassifier('D:/Naval Projects/Spotrs_Person_Classifier/server/haarcascades/haarcascade_eye.xml')
